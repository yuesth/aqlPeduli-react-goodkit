    ...
    const listcarousel = programcar.map((doc, idx) => {
        return (
            <div className="w-100 wrap">
                <img className="img-fluid" src={doc.gambar} alt="..." width="978" height="550" />
            ...
            <div className="container-xl">
                <div className="row">
                    <div className="col-12">
                        ...
                        {/* <div className="flickity-buttons-overlap border border-7 border-white shadow-lg carousel-main-car-landing" > */}
