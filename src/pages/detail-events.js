                            ...
                            <div className="col-md-10 col-lg-9">
                                <div className="row no-gutters">
                                    ...
                                    <div className="col justify-content-end text-right d-flex">
                                        <div className="smd">
                                            <a href={`https://twitter.com/intent/tweet?text=${detailberita.judul}%20melalui%20https%3A//aqlpeduli.or.id/events/${detailberita.linkshare}${query}`} target="_blank" className="d-flex flex-column mx-3">
                                        ...
                                        <div className="smd">
                                            <a href={`https://www.facebook.com/sharer/sharer.php?u=https%3A//aqlpeduli.or.id/events/${detailberita.linkshare}${query}`} target="_blank" className="d-flex flex-column mx-3">
                                        ...
                                        <div className="smd">
                                            <a href={`https://t.me/share/url?url=https%3A//aqlpeduli.or.id/events/${detailberita.linkshare}${query}&text=${detailberita.judul}`} target="_blank" className="d-flex flex-column mx-3">
                                        ...
                                        <div className="smd">
                                            <a href={`https://api.whatsapp.com/send?text=${detailberita.judul}%20melalui%20https%3A//aqlpeduli.or.id/events/${detailberita.linkshare}${query}`} target="_blank" className="d-flex flex-column mx-3">
                                        ...
                                        <div className="smd">
                                            <CopyToClipboard onCopy={handlecopy} text={`https://aqlpeduli.or.id/events/${detailberita.linkshare}${query}`}>
