...
function BeritaInternasional() {
    ...
    const urlBerita2 = "https://peaceful-meadow-45867.herokuapp.com/beritas?_where[kategoriberita.namaKategori]=Berita%20Internasional&_start=0&_limit=5"
    ...
    const generateDataBerinter = () => {
        setTimeout(() => {
            fetch(`https://peaceful-meadow-45867.herokuapp.com/beritas?_where[kategoriberita.namaKategori]=Berita%20Internasional&_start=${start}&_limit=4`)
