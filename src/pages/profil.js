...
function Profil() {
    ...
    return (
        ...
        <>
            ...
            <FooterGK></FooterGK>
            {/* <section className="pt-10 pt-md-12 bg-white">
                            ...
                            <div className="card rounded-top-left-lg rounded-bottom-right-lg">
                                <div className="row no-gutters position-relative">
                                    <div className="col-md-6">
                                        <div className="card-img-slider rounded-top-left-lg overflow-hidden" data-flickity="{&quot;fade&quot;: true, &quot;imagesLoaded&quot;: true, &quot;pageDots&quot;: false, &quot;prevNextButtons&quot;: false, &quot;asNavFor&quot;: &quot;#testmonialsSlider&quot;, &quot;draggable&quot;: false}">
                                            <div className="w-100 bg-cover" style={{ backgroundImage: `url(${process.env.PUBLIC_URL}/dist/assets/img/avatars/avatar-jumbo-1.jpg)` }}>
                                                <img src="assets/img/avatars/avatar-jumbo-1.jpg" alt="..." className="img-fluid invisible" />
                                            </div>
                                    ...
                                    <div className="col-md-6 position-static">
                                        <div className="card-body py-9 py-lg-11">
                                            <div className="flickity-soft-edges flickity-buttons-adjacent flickity-buttons-rounded flickity-buttons-bottom-left position-static mx-n4" data-flickity="{&quot;imagesLoaded&quot;: true, &quot;pageDots&quot;: false, &quot;wrapAround&quot;: true}" id="testmonialsSlider">
            ...
            {/* <div className="main-carousel">
                {listkk} */}
            {/* <div className="carousel-cell" style={{ width: `300px`, height: `170px` }}>
                    <img className="carousel-cell-image" src={`http://167.99.72.148/uploads/konten3_6e9248e8f6.jpg`} alt="" />
                </div>
                <div className="carousel-cell" style={{ width: `300px`, height: `170px` }}>
                    <img className="carousel-cell-image" src={`http://167.99.72.148/uploads/konten3_6e9248e8f6.jpg`} alt="" />
                </div>
                ...
                <div className="carousel-cell" style={{ width: `300px`, height: `170px` }}>
                    <img className="carousel-cell-image" src={`https://s3-us-west-2.amazonaws.com/s.cdpn.io/82/orange-tree.jpg`} alt="" />
                </div> */}
            {/* </div> */}
